# Generated by Powerlevel10k configuration wizard on 2023-11-21 at 15:15 EST.
...
() {
  ...
  #
  # leaving blank gets rid of home icon
  typeset -g POWERLEVEL9K_DIR_CLASSES=()
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%F{#f1502f}'   # default foreground
      local      clean='%2F{#f1502f}'  # green foreground
      local   modified='%3F{#f1502f}'  # yellow foreground
      local  untracked='%4F{#f1502f}'  # blue foreground
      local conflicted='%1F{#f1502f}'  # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%f{#f1502f}'  # default foreground
      local      clean='%f{#f1502f}'  # default foreground
      local   modified='%f{#f1502f}'  # default foreground
      local  untracked='%f{#f1502f}'  # default foreground
      local conflicted='%f{#f1502f}'  # default foreground
    fi
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=#9d7cd8
  ...
  ##############################[ node_version: node.js version ]###############################
  # Node version color.
  typeset -g POWERLEVEL9K_NODE_VERSION_FOREGROUND=#68a063
