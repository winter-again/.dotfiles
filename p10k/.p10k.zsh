# Generated by Powerlevel10k configuration wizard on 2023-08-10 at 22:50 EDT.
...
() {
  ...
  # make some end symbols transparent
  # typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL=
  ...
  # use 'none' for transparency, but then left with final separator symbol
  # that won't follow transparency
  ...
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND='#1a1b26'
  ...
  function my_git_formatter() {
    ...
    local       meta='%F{#f1502f}' # white foreground
    local      clean='%F{#f1502f}' # black foreground
    local   modified='%F{#f1502f}' # black foreground
    local  untracked='%F{#f1502f}' # black foreground
    local conflicted='%F{#f1502f}' # red foreground
  ...
  typeset -g POWERLEVEL9K_GCLOUD_BACKGROUND='none'
